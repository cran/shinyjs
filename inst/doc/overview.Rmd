...
user-friendly.  First we need to set up the app to use `shinyjs` by making a call to `useShinyjs()` anywhere in the Shiny app's UI. This is
required in order to set up all the JavaScript and a few other things for `shinyjs` to work properly.
